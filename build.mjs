...
for (const name of ['index.html', 'app.html', 'site.css', 'wallet-media.css', 'site.js', 'documents.js', 'styles.css', 'typography.css', 'main.js', 'typography.js', 'loader.css', 'loader.js']) {
